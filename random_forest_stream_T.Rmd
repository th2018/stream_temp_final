...
meanAugT_all_water_fire_2 #WHY A FIRE HAS MULTIPLE POLYGONS?
```


#clean the fire data
```{r}
water_fire<-read.dbf("C:/Users/taohuang/Documents/Tao/Data/norwest/West_Mnts_mtbs.dbf")
...
```{r}
#save(meanAugT_all_water_fire_2,file="meanAugT_all_water_fire_2.Rdata")
load("meanAugT_all_water_fire_2.Rdata")
```
